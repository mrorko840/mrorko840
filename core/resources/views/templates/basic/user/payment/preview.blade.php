...
<div style="background-image: linear-gradient(to bottom right, #ff5a5a, #b90000);" class="container pt-4 pb-3 mt-5 mb-2">
    <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="list-group text-center">
                            ...
                            <p class="list-group-item border border-warning">
                                @lang('Amount'):
